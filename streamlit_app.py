...
TRANSLATIONS = {
    'en': {
        ...
        'force_whisper_help': 'Ignore platform subtitles and force local ASR generation. English uses faster-whisper; Chinese uses Paraformer.',
    ...
    'zh': {
        ...
        'force_whisper_help': '忽略平台字幕并强制使用本地 ASR 生成字幕。英文走 faster-whisper，中文走 Paraformer。',
